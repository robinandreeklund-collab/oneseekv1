...
export function FeaturesBentoGrid() {
	...
	const items = [
		{
			title: t("features.find_ask_act.title"),
			description: t("features.find_ask_act.description"),
			header: (
				<CitationIllustration
					title={t("features.citation_illustration_title")}
					referencedChunk={t("features.referenced_chunk")}
				/>
			),
		...
		{
			title: t("features.real_time_collab.title"),
			description: t("features.real_time_collab.description"),
			header: (
				<CollaborationIllustration
					label={t("features.collab_illustration_label")}
					realTime={t("features.real_time")}
					collabPart1={t("features.collab_part1")}
					collabPart2={t("features.collab_part2")}
					collabPart3={t("features.collab_part3")}
				/>
			),
		...
		{
			title: t("features.beyond_text.title"),
			description: t("features.beyond_text.description"),
			header: <AudioCommentIllustration altText={t("features.beyond_text.title")} />,
			className: "md:col-span-1",
			icon: <IconMicrophone className="h-4 w-4 text-neutral-500" />,
		},
		{
			title: t("features.context_counts.title"),
			description: t("features.context_counts.description"),
			header: (
				<AnnotationIllustration
					label={t("features.annotation_illustration_label")}
					addContextWith={t("features.add_context_with")}
					comments={t("features.comments")}
					exampleComment={t("features.example_comment")}
				/>
			),
			className: "md:col-span-2",
			...
			<div className="relative flex h-fit w-fit flex-col items-start">
				<div className="w-full text-2xl sm:text-3xl lg:text-4xl leading-tight text-neutral-700 dark:text-neutral-300">
					<span className="flex items-stretch flex-wrap">
						...
						<span>{collabPart1}</span>
						<span>{collabPart2}</span>
						<span className="relative z-10 inline-flex items-stretch justify-start">
