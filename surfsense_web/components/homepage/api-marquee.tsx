...
const SWEDISH_APIS: SwedishAPI[] = [
	{
		name: "SCB",
		desc: "Statistiska Centralbyrån",
		color: "from-blue-500 to-blue-600",
		logo: "/api-logos/scb-logo.png",
	},
	{
		name: "SMHI",
		desc: "Klimat & Väderdata",
		color: "from-cyan-500 to-teal-600",
		logo: "/api-logos/smhi-logo.png",
	},
	{
		name: "Bolagsverket",
		desc: "Företagsregister",
		color: "from-amber-500 to-orange-600",
		logo: "/api-logos/bolagsverket-logo.png",
	},
	{
		name: "Trafikverket",
		desc: "Infrastruktur & Trafik",
		color: "from-emerald-500 to-green-600",
		logo: "/api-logos/trafiklab.png",
	},
	{
		name: "Riksdagen",
		desc: "Lagstiftning & Politik",
		color: "from-red-500 to-rose-600",
		logo: "/api-logos/riksdagen-logo.png",
	},
	{
		name: "Nord Pool",
		desc: "Energipriser & Elmarknad",
		color: "from-indigo-500 to-blue-600",
		logo: "/api-logos/Nord_Pool_Logo.png",
	},
	{
		name: "Skolverket",
		desc: "Utbildningsstatistik",
		color: "from-teal-500 to-cyan-600",
		logo: "/api-logos/skolverket-logo.png",
	},
	{
		name: "Tavily",
		desc: "Webbsökning",
		color: "from-indigo-500 to-blue-600",
		logo: "/api-logos/tavily-logo.png",
	},
	{
		name: "Blocket",
		desc: "Marknadsplats",
		color: "from-red-500 to-red-600",
		logo: "/api-logos/blocket-logo.png",
	},
	{
		name: "Tradera",
		desc: "Auktioner & Handel",
		color: "from-blue-500 to-blue-600",
		logo: "/api-logos/tradera-logo.png",
	},
