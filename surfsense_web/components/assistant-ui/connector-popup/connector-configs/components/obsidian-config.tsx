		...
		<div className="space-y-6">
			...
			<div className="rounded-xl border border-border bg-slate-400/5 dark:bg-white/5 p-3 sm:p-6 space-y-3 sm:space-y-4">
				...
				<div className="space-y-4">
					<div className="space-y-2">
						<Label className="text-xs sm:text-sm">Valvsökväg</Label>
						<Input
							value={vaultPath}
							onChange={(e) => handleVaultPathChange(e.target.value)}
							placeholder="/sokvag/till/ditt/obsidian/valv"
							className="border-slate-400/20 focus-visible:border-slate-400/40 font-mono"
						/>
						<p className="text-[10px] sm:text-xs text-muted-foreground">
							Den absoluta sökvägen till ditt Obsidian-valv på servern.
						</p>
					</div>

					<div className="space-y-2">
						<Label className="text-xs sm:text-sm">Valvnamn</Label>
						<Input
							value={vaultName}
						...
						/>
						<p className="text-[10px] sm:text-xs text-muted-foreground">
							Ett visningsnamn för ditt valv i sökresultat.
						</p>
					</div>

					<div className="space-y-2">
						<Label className="text-xs sm:text-sm">Exkludera mappar</Label>
						<Input
					...
					<div className="flex items-center justify-between rounded-lg border border-slate-400/20 p-3">
						<div className="space-y-0.5">
							<Label className="text-xs sm:text-sm">Inkludera bilagor</Label>
							<p className="text-[10px] sm:text-xs text-muted-foreground">
								Indexera bilagemappar och inbäddade filer
							</p>
						</div>
