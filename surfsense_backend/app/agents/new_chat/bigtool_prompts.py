...
- Om hämtade verktyg inte kan besvara den aktuella frågan, kör retrieve_tools igen med en förfinad sökning.
...
- Om hämtade verktyg inte passar uppgiften eller obligatoriska fält saknas, kör retrieve_tools igen med tydligare begränsningar.
- Om användaren byter ämne/domän, sluta tvinga fram tidigare verktygsval och kör retrieve_tools igen.
