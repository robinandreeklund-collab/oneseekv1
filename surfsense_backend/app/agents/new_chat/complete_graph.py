...
async def build_complete_graph(
    *,
    ...
    return await create_supervisor_agent(
        ...
        riksdagen_dokument_prompt=riksdagen_dokument_prompt,
        riksdagen_debatt_prompt=riksdagen_debatt_prompt,
        riksdagen_ledamoter_prompt=riksdagen_ledamoter_prompt,
