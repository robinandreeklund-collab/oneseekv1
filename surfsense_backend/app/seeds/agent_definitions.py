...
DEFAULT_AGENT_DEFINITIONS: list[dict[str, Any]] = [
    ...
    # ── Riksbanken agent (räntor, valutakurser, prognoser) ──
    {
        "agent_id": "riksbank-ekonomi",
        "domain_id": "ekonomi-och-skatter",
        "label": "Riksbanken Räntor, Valutor & Prognoser",
        "description": (
            "Hämtar räntor, valutakurser och makroekonomiska prognoser "
            "från Riksbanken — styrränta, STIBOR, SWESTR, växelkurser, "
            "inflationsprognos, BNP-prognos."
        ),
        "keywords": [
            "riksbanken",
            "styrränta",
        ...
        "priority": 100,
        "enabled": True,
        "prompt_key": "riksbank_prompt",
        "primary_namespaces": [["tools", "riksbank", "ekonomi"]],
        "fallback_namespaces": [["tools", "riksbank"]],
        "worker_config": {"max_concurrency": 4, "timeout_seconds": 120},
        "main_identifier": "RiksbankAgent",
        "core_activity": "Hämtar räntor, valutakurser och prognoser från Riksbanken",
        "unique_scope": "Riksbankens räntor, valutakurser och makroprognoser",
        "geographic_scope": "Sverige",
        "excludes": ["väder", "trafik", "skapa"],
    },
    # ── Elpris agent (spotpriser) ──
    {
        "agent_id": "elpris",
        "domain_id": "energi-och-miljö",
        "label": "Elpriser & Spotpriser",
        "description": (
            "Hämtar aktuella och historiska elpriser (spotpriser) "
            "per elområde i Sverige — SE1, SE2, SE3, SE4."
        ),
        "keywords": [
            "elpris",
            "elpriser",
        ...
        "priority": 100,
        "enabled": True,
        "prompt_key": "elpris_prompt",
        "primary_namespaces": [["tools", "elpris", "energi"]],
        "fallback_namespaces": [["tools", "elpris"]],
        "worker_config": {"max_concurrency": 4, "timeout_seconds": 120},
        "main_identifier": "ElprisAgent",
        "core_activity": "Hämtar elpriser och spotpriser per elområde",
        "unique_scope": "Svenska elpriser och spotpriser per elzon",
        "geographic_scope": "Sverige",
        "excludes": ["väder", "trafik", "skapa"],
    },
    # ── Trafikanalys agent (transportstatistik) ──
    {
        ...
        "priority": 100,
        "enabled": True,
        "prompt_key": "trafikanalys_prompt",
        "primary_namespaces": [["tools", "trafikanalys-transport"]],
        "fallback_namespaces": [["tools", "trafikanalys-transport"]],
        "worker_config": {"max_concurrency": 4, "timeout_seconds": 120},
        "main_identifier": "TrafikanalysAgent",
        "core_activity": "Hämtar transportstatistik från Trafikanalys",
        "unique_scope": "Svensk transportstatistik — fordon, trafik, olyckor, sjö, luft, järnväg",
        "geographic_scope": "Sverige",
        "excludes": ["väder", "realtid", "skapa"],
    },
    {
        "agent_id": "bolag",
        "domain_id": "näringsliv-och-bolag",
